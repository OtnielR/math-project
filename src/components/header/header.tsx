...
export default function Header() {
    return (
        <>
            <header className="relative w-full min-h-screen flex flex-col p-2 py-8 md:p-4 md:py-4 gap-6 md:gap-4">
                <Navbar></Navbar>
                <div className="w-full h-full bg-[#43B869] rounded-xl flex-1 flex flex-col-reverse gap-6 md:gap-2 md:grid md:grid-cols-2 lg:grid-cols-3 px-4 lg:px-12 py-6 lg:py-8">
                    <div className="col-span-1 lg:col-span-2" id="left">
                        <div className="lg:w-4/5 h-full flex flex-col justify-center gap-4 px-4">
                            <div className="border-b border-gray-600 pb-6">
                                <h1 className="text-6xl md:text-8xl lg:text-9xl font-bold tracking-wide">Quizs</h1>
                            </div>
                            <div className="border-b border-gray-600 pb-6 mb-2">
                                <p className="text-xs/6 lg:text-sm/6 tracking-wide line-clamp-2 lg:line-clamp-none">Kedudukan garis terhadap lingkaran — materi dan kuis interaktif. Pahami konsep kedudukan garis terhadap lingkaran dengan materi Matematika Kelas 11 yang sederhana dan kuis interaktif untuk latihan. </p>
                            </div>
