export default function Navbar() {
    return (
        <>
            <nav className=" w-full h-4 md:h-8 lg:h-10 flex justify-between items-center px-2 md:px-8 md:py-2 ">
                <section>
                ...
                <section>
                    <div className=" bg-black text-white text-xs md:text-sm px-3 py-2 lg:px-4 lg:py-2 rounded-3xl ">
                        Progress: 0%
                    </div>
                </section>
            </nav>
